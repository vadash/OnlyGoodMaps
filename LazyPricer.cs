...
namespace PickIt
{
    public class PickIt : BaseSettingsPlugin<PickItSettings>
    {
        ...
        private readonly WaitTime _toPick = new WaitTime(3);
        private readonly WaitTime _wait3Ms = new WaitTime(1);
        private readonly WaitTime _waitForNextTry = new WaitTime(8);
